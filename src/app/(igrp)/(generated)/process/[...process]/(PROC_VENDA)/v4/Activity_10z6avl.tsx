...
export default function Activity_10z6avl({ processKey, processInstanceId, userTaskInstanceId, onRegisterMethods, variables } : { processKey: string, processInstanceId: string, userTaskInstanceId: string, onRegisterMethods: (methods: StepMethods) => void, variables?: Array<{ name: string; value: string }> | undefined }) {

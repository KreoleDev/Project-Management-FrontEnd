...
export default {
  ...
  components: ['components/project-slider','components/InteractiveMap','components/MapLocations','components/project-progress', 'components/ExcelUploadModal', 'components/details-report']
};